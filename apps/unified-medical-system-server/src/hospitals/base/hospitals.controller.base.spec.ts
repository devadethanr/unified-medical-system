...
const CREATE_INPUT = {
  createdAt: new Date(),
  hsptlHospitalName: "exampleHsptlHospitalName",
  hsptlLocation: "exampleHsptlLocation",
  hsptlRolesId: 42,
  hsptlUmsId: "exampleHsptlUmsId",
  id: "exampleId",
  updatedAt: new Date(),
};
const CREATE_RESULT = {
...
const service = {
  ...
  hospitalsItems: () => FIND_MANY_RESULT,
  hospitals: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
